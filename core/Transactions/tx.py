...
class TxFetcher:
    ...
    def dump_cache(cls, filename):
        with open(filename, 'w') as f:
            to_dump = {k: tx.serailize().hex() for k, tx in cls.cache.items()}
...
class TxIn:
    ...
    def serialize(self):
        'Returns byte serialization of transaction input'
    ...
    def value(self, testnet=False):
        '''Get the output value by looking at the tx hash 
    ...
    def script_pubkey(self, testnet=False):
        '''Get the script pubkey by looking up the Tx hash
...
class TxOut:
    ...
    def serialize(self):
        '''Returns a byte serialization of tx_output'''
